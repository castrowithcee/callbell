---
name: callbell-core-statusline
description: >
  Die Statusline des aktuellen Hosts einrichten und konfigurieren. Unter Claude Code einen konfigurierbaren
  Renderer mit schalt- und färbbaren Widgets für Modell, Reasoning, Ordner, Git, Tokens, Kosten und
  Nutzungslimits installieren. Unter Codex CLI den nativen TUI-Footer mit den nächstliegenden Anzeigen für
  Modell, Projekt, Git, Kontext, Tokens und Nutzungslimits konfigurieren. Durch Nennung von
  callbell-core-statusline starten und gewünschte Aktivierung, Deaktivierung oder Farbe angeben.
disable-model-invocation: true
argument-hint: "[Elemente aktivieren/deaktivieren/färben]"
license: MIT
type: skill
edit: locked
---

# callbell-core-statusline
...
`<plugin-root>` ist der Ordner, aus dem der Skill geladen wurde. Der Session-Kontext kann ihn als
`CALLBELL PLUGIN ROOT` nennen; sonst liegt er zwei Ebenen über dieser `SKILL.md`. Setze vor einem
Script-Aufruf den echten absoluten Pfad ein. Nie fest codieren, denn der Installationspfad trägt die Version.
...
1. Führe aus: `node "<plugin-root>/scripts/callbell-core-statusline-setup-claude.js"`
...
Führe aus: `node "<plugin-root>/scripts/callbell-core-statusline-setup-codex.js"`
