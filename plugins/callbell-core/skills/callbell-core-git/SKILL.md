...
description: >
  ...
  für die automatische Git-Prüfung des Callbell-Cores aufrufen.
...
Verwalte Git als eigenen Arbeitszweck. Die automatische Prüfung beim Sessionstart gehört zum Callbell-Core
und lädt diesen Skill nicht. Sobald Git selbst bearbeitet werden soll, gilt der passende Zweig unten.
...
und Worktrees. Der Hauptagent, nicht der Worker, führt die Git-Schritte aus.

Auch dort muss der Hauptagent jeden vollständigen Diff lesen, fremde Änderungen ausschließen und die
