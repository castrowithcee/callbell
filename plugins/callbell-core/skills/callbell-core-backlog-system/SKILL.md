---
name: callbell-core-backlog-system
description: >
  Wechselt oder migriert auf ausdrücklichen Aufruf das maßgebliche Planungssystem eines Callbell-Projekts:
  lokal nach extern, extern nach lokal oder zwischen externen Werkzeugen. Klärt Datenmodell, Statusabbildung,
  Authentifizierung, API-Grenzen und Verifikation, verhindert parallele Spiegel und hält das neue Binding
  dauerhaft in __callbell__/backlog/BACKLOG.md fest. Durch Nennung von callbell-core-backlog-system starten.
...
3. Ermittle für beide Seiten Titel, Container oder Projekt, Task-Artefakt, Entwurfsform, Status, Felder,
   ...
   standardmäßig liest.
4. Lies immer [das neutrale Adapterverfahren](references/custom.md). Für GitHub lies zusätzlich
   [die GitHub-Besonderheiten](references/github.md). Für einen später ergänzten bekannten Anbieter gilt
...
[`assets/github-project-config.yaml`](assets/github-project-config.yaml) als veränderbaren Ausgangspunkt,
...
[`assets/external-backlog-binding.md`](assets/external-backlog-binding.md) als Ausgangspunkt. Lies eine
