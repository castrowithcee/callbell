...
Dieser Skill platziert Inhalt im Projekt **außerhalb** von `__callbell__/`. Diese Schicht folgt der
Scaffold-Norm des Callbell-Kerns, und nichts hier gilt für sie.
...
Kaskade läuft über die `FRAMEWORK.md`- und `INDEX.md`-Knoten nach der Core-Norm, nicht über automatisches
