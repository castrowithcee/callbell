---
description: >
  Immer geladene Weiche zum Callbell-Scaffold und seinem vollständigen Vertrag vor schreibender Arbeit
  unter __callbell__/.
license: MIT
type: rule
edit: locked
...
Diese Regel gilt, sobald im Projekt `__callbell__/` existiert oder der Einstiegsskill es anlegt. Der Ordner
ist Callbells versionierte, projekttypneutrale Zustands- und Arbeitsschicht und kein gewöhnlicher
...
Bevor du außerhalb von `__callbell__/backlog/` eine Datei im Scaffold erstellst, inhaltlich änderst,
